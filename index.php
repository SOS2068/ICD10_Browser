                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                        ...
                        $result = $conn->query($block_sql);
                        while($row = $result->fetch_assoc()){
                          echo '<div class="h5 mb-0 font-weight-bold text-gray-800"/>'. $row["num"].' Categorys </div>';
                        }
                        $conn->close();
                      ?>
                    </div>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" id ="#multiCollapseExample2">
                  <h6 class="m-0 font-weight-bold text-primary">Test PieChart</h6>
